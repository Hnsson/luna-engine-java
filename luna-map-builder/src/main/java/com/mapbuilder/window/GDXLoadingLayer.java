...
public class GDXLoadingLayer extends WindowLayer {
  ...
  public GDXLoadingLayer(int width, int height, String targetMap, StateMachine<WindowLayer> fsm,
  ...
  @Override
  public String getId() {
    return "MAPBUILDER_LOADING_LAYER";
  }
  ...
  public void enter() {
    ...
    assetManager.loadAllTextures("assets/levels/" + targetMap);
  }
  ...
  public void update(float delta) {
    ...
    if (isDone) {
      ...
      fsm.popLayer();
      fsm.pushLayer(new GDXMapEditorLayer(width, height, targetMap, assetManager));
    }
  }
